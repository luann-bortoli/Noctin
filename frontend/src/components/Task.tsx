...
interface TaskProps{
    ...
    updateTask: () => void
    showEdit: () => void
    setProps: (title:string, content:string, priority:number, id:number) => void
}

export default function Task({id, title, content, priority, created, deleteTask, updateTask, showEdit, setProps}: TaskProps){

    const [priorityString, setPriorityString] = useState(handlePriority())
        ...
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.titleContainer}>
                    ...
                    <p className={styles.priority}>{priorityString}</p>
                </div>
                ...
                <div className={styles.actionContainer}>
                    <button onClick={()=> (showEdit(), setProps(title, content, priority, id)) }>
